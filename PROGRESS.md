...
| P0-C2 | Remove duplicate `organize_desktop` + duplicate shutdown tool | DEP: P0-A ✅signed | 🔶 | zcode-p0c 2026-09-07 | gate LIFTED (P0-A merged @ 42e262e) — executing: drop undeclared `shutdown_jarvis` registry alias; keep `desktop.py` `organize_desktop` (OS-aware skips, by_type/by_date), remove `file_controller.py` duplicate + its declaration token |
...
| P0-C4 | Name purge: JARVIS/HUNNY aliases → **ULTRON** only | DEP: P0-A ✅signed | 🔶 | zcode-p0c 2026-09-07 | gate LIFTED (P0-A merged @ 42e262e) — executing name purge on merged tree (post-P0-B state) |
